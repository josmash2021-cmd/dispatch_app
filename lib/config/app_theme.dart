...
class AppColors {
  ...
  static const Color accepted     = Color(0xFFE8BD5A);   // bright gold — driver on way
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme(ThemeData.dark().textTheme).copyWith(
        ...
        bodySmall: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.textHint),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          ...
          return GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.textSecondary);
        }),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          foregroundColor: AppColors.textPrimary,
          side: BorderSide(color: Colors.white.withValues(alpha: 0.10), width: 1.5),
          minimumSize: const Size.fromHeight(52),
          padding: const EdgeInsets.symmetric(horizontal: 28, vertical: 14),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(28)),
          textStyle: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700),
